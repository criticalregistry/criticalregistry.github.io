...
**The AI acceleration problem** has crossed a threshold in early 2026 that makes previous projections look conservative. Daniel Stenberg, curl's primary maintainer, reported in April 2026 that security report submission rates had more than doubled year-over-year and projected approximately fifty curl CVEs in 2026 against a historical baseline of roughly sixteen per year. He confirmed the same trend across dozens of other major projects. That data predates the Mythos findings by days.
